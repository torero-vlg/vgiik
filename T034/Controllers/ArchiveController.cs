...
namespace T034.Controllers
{
    public class ArchiveController : Controller
    {
        public ActionResult Person(int personId)
        {
            ...
            {
                model.FullName =
                    "Карташова Клавдия Петровна - ветеран Великой Отечественной войны, преподаватель, и.о. директора, заведующая Сталинградской-Волгоградской школы, училища культуры";
