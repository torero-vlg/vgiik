...
namespace T034.Controllers
{
    public class HomeController : BaseController
    {
        ...
        public ActionResult Photo()
        {
            ...
            directory = new DirectoryInfo(Server.MapPath("/Content/images/photo/stalingrad_siren/"));
            files = directory.Exists ? directory.GetFiles().Select(f => f.Name) : new List<string>();
            var stalingrad_siren = files.Select(file => new NodeViewModel { Path = "/Content/images/photo/stalingrad_siren/" + file, Description = "" });
            ...
            var model = new List<CarouselViewModel>
                {
					...
					new CarouselViewModel(stalingrad_siren, "Сталинградская сирень", "")
                };
